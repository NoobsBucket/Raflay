...
export async function generateMetadata() {
  return {
    title: "Blog | Raflay",
    description: "Explore Raflay blog articles with software, video, and design filters.",
  };
}
      ...
      <main style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 20px" }}>
        <section style={{ marginBottom: 40 }}>
          ...
          <p style={{ fontFamily: "'Jost', sans-serif", fontSize: 18, color: "#444", maxWidth: 760, lineHeight: 1.75, marginTop: 18 }}>
            Read Raflay insights on web, mobile, software, AI, and video production. Use the filters to surface software or video editing content quickly.
          </p>
        </section>
